...
class _MainCategoriesState extends State<MainCategories> {
  ...
  Widget build(BuildContext context) {
                                ...
                                onTap: (){
                                  showDialog(context: context,
                                      builder: (BuildContext context){
                                        return CustomDialogBox(data: Categories, setGroup: (id){
                                          setGroup(id);
                                        },);
                                      }
                                  );
                    ...
                    children: [
                      Container(
                          ...
                          child: Padding(
                              ...
                              child: Wrap(
                                children: [
                                  Text(group_name, style: TextStyle(fontWeight: FontWeight.w400, fontSize: 14, color: Colors.white),textAlign: TextAlign.center),
                                  Padding(
                                      padding: EdgeInsets.only(
                      ...
                      if(groupcategories != null)
                        Container(
                            ...
                            child: Padding(
                                ...
                                child: Wrap(
                                  children: [
                                    Text(groupcategories, style: TextStyle(fontWeight: FontWeight.w400, fontSize: 14, color: Colors.white),textAlign: TextAlign.center),
                                    Padding(
                                        padding: EdgeInsets.only(
                                            left: 5, right: 5, top:0, bottom: 0),
                                        child: GestureDetector(
    ...
    return  Container(
                                      ...
                                      child: CustomDialogBox2(data: subGroup, setGroup: (id){
                                        setSubGroup(id);
                                      },)
                                    );});
                                  },
                                  child: Wrap(
                                    children: [
                                      Text('Select Sub-category', style: TextStyle(fontWeight: FontWeight.w400, fontSize: 14, color: Colors.white),textAlign: TextAlign.center),
                                      Padding(
                                          padding: EdgeInsets.only(
                                              left: 5, right: 5, top:0, bottom: 0),
                                          child: GestureDetector(
  ...
  getCategories() async {
    ...
    if (response is SuccessState) {
      if (response.value['status'] == true) {
        setState(() {
          Categories = response.value['data'];
        });
      }
    }
  }
  ...
  setGroup(data) {
    ...
    setState(() {
      ...
      subGroup = data['groupcategories'];
    });
    getProductsByGroup();
  }
  setSubGroup(data) {
    setState(() {
      groupcategories_id=data['id'].toString();
      groupcategories = data['name'];
    });
    getProductsByGroup();
  }
  ...
  getProductsByGroup() async {
    Result response = await authService.getProductsByGroup(group_id, groupcategories_id);
    if (response is SuccessState) {
      if (response.value['status'] == true) {
        setState(() {
          products = response.value['data'];
          searchproducts = response.value['data'];
          loading = false;
        });
      } else {
        setState(() {
