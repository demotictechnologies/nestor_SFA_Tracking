...
class AddChemistPage extends StatefulWidget {
  AddChemistPage({Key key}) : super(key: key);

  @override
  _AddChemistPageState createState() => _AddChemistPageState();
}
...
class _AddChemistPageState extends State<AddChemistPage> {
  ...
  TextEditingController dlNumberCtrl = TextEditingController(text: '');
  String dlNumber;
  String dlNumberError;

  TextEditingController gstCtrl = TextEditingController(text: '');
  String gst;
  String gstError;

  TextEditingController contactPersonCtrl = TextEditingController(text: '');
  ...
  TextEditingController territoryCtrl = TextEditingController(text: '');
  String territory;
  String territoryError;

  TextEditingController areaCtrl = TextEditingController(text: '');
  String area;
  String areaError;
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text('New Chemist',style: TextStyle(color: Colors.black26, fontSize: 20, fontWeight: FontWeight.w600),),
                                  )
                              )
                          ),
                          Container(
                          ...
                          Container(
                            ...
                            child: Padding(
                                ...
                                child: BorderButton(Title: 'Save', onClick: (){
                                  // addAddress();
                                },)
                            ),
                          ),
